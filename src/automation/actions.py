...
class UIActions:
    ...
    async def human_type(self, locator: Locator, text: str, clear_first: bool = True):
        """
        Type text in a human-like manner.
        
        Args:
            locator: Playwright locator for input field
            text: Text to type
        ...
        for char in text:
            await locator.type(char, delay=random.randint(
    ...
    async def human_click(self, locator: Locator):
        ...
        Args:
            locator: Playwright locator for element
        """
    ...
    async def select_dropdown(self, locator: Locator, value: str):
        """
